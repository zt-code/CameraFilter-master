...
public class VideoEncoderCore {
    ...
    private static final String TAG = "why-VideoEncoderCore";
    ...
    private int sampleRate = 24000;   //音频采样率
    ...
    public void drainEncoder(boolean endOfStream) {
        ...
        Log.i(TAG, "drainEncoder(" + endOfStream + ")");
...
//                    encodedData.limit(mBufferInfo.offset + mBufferInfo.size);
                    if (mMuxerStarted) {
                        ...
                        Log.i(TAG, "sent " + mBufferInfo.size + " bytes to muxer, ts=" +
            ...
            do {
                ...
                if (outIndex >= 0) {
                    ...
                    synchronized (lock) {
                        ...
                        Log.i(TAG, "add audio track-->" + mAudioTrackIndex);
