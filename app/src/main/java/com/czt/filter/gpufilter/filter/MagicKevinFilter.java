...
public class MagicKevinFilter extends GPUImageFilter {
	...
	public MagicKevinFilter(){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.filter_kevin_new));
	}
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(OpenGL.context, "filter/filter_kelvin.png");
		    }
	    });
	}
}
