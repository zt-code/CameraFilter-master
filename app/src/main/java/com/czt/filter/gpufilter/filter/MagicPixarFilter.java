...
public class MagicPixarFilter extends GPUImageFilter {
	...
	public MagicPixarFilter(){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.filter_pixar));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(OpenGL.context, "filter/filter_pixar_curves.png");
		    }
	    });
	}
}