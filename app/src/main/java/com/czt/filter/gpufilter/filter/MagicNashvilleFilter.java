...
public class MagicNashvilleFilter extends GPUImageFilter {
	...
	public MagicNashvilleFilter(){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.filter_nashville));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(OpenGL.context, "filter/filter_nashville.png");
		    }
	    });
	}
}
