...
public class MagicValenciaFilter extends GPUImageFilter {
	...
	public MagicValenciaFilter(){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.filter_valencia));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(OpenGL.context, "filter/filter_valencia.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(OpenGL.context, "filter/filter_valenciagradient.png");
		    }
	    });
	}
}
