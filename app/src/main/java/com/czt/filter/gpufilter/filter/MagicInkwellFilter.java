...
import static com.czt.filter.gpufilter.basefilter.GPUImageFilter.NO_FILTER_VERTEX_SHADER;
...
public class MagicInkwellFilter extends GPUImageFilter {
	...
	public MagicInkwellFilter(){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.filter_inkwell));
	}
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(OpenGL.context, "filter/filter_inkwell.png");
		    }
	    });
	}
}
