...
public class MagicWarmFilter extends GPUImageFilter {
	...
	public MagicWarmFilter(){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.filter_warm));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(OpenGL.context, "filter/filter_warm_layer.jpg");
		        mMaskGrey2TextureId = OpenGlUtils.loadTexture(OpenGL.context, "filter/filter_bluevintage_mask.jpg");
		    }
	    });
	}
}
